<template>
  <main class="terms-and-conditions-page">
    <section>
      <h1 class="descriptive-text-title">Terms & Conditions</h1>
      <h1 class="descriptive-text-title">1. Your Agreement with The Wise Miser</h1>
      ...
      <h1 class="descriptive-text-title">7. Flights and Flight Travel Documents</h1>
      <p class="descriptive-text-body">
      ...
      <h1 class="descriptive-text-title">
      ...
      <h1 class="descriptive-text-title">Compensation Table</h1>
      <p class="descriptive-text-body">55-29 days £10</p>
      <p class="descriptive-text-body">28-15 days £20</p>
      <p class="descriptive-text-body">14-8 days £30</p>
      <p class="descriptive-text-body">7-0 days £40</p>
      <p class="descriptive-text-body">
      ...
      <h1 class="descriptive-text-title">21. Travel Advice</h1>
      <p class="descriptive-text-body">
        The Foreign and Commonwealth Travel Advice Unit may have issued information about your holiday destination. We strongly advise you go to www.fco.gov.uk to find out more about your destination/s prior to the commencement of travel
      </p>
      <h1 class="descriptive-text-title">22. If You Have a Complaint</h1>
      <p class="descriptive-text-body">
